    ...
    public void onCreate( Bundle savedInstanceState) {
        ...
        leo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent proIntent = new Intent(SearchData.this, UserProfile.class);
                SearchData.this.startActivity(proIntent);
            }
        });
        ...
        bottomNavigationView.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                {
                    case R.id.home_icon:
                        Intent intent0 = new Intent(SearchData.this, Home.class);
                        startActivity(intent0);
                        break;

                    case R.id.search_icon:
                        Intent intent1 = new Intent(SearchData.this, SearchData.class);
                        startActivity(intent1);
                        break;

                    case R.id.message_icon:
                        Intent intent2 = new Intent(SearchData.this, Message.class);
                        startActivity(intent2);
                        break;

                    case R.id.activity_icon:
                        Intent intent3 = new Intent(SearchData.this, Notification.class);
